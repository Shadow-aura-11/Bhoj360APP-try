...
app.use('/r/:restaurantId', (req, res, next) => {
  ...
  if (entry && entry.active === false) {
    ...
    const apiRoots = ['/auth', '/tables', '/menu', '/orders', '/reservations', '/analytics', '/health', '/uploads', '/manifest.json', '/staff', '/settings', '/customers', '/coupons', '/expenses', '/inventory', '/s', '/outlets', '/venues', '/items', '/locations', '/receipts', '/shipments', '/returns', '/docks', '/yard', '/tasks', '/equipment', '/ai'];
