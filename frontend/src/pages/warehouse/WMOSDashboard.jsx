...
export default function WMOSDashboard() {
  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        // Fetch base stats
        const response = await fetch(`/r/${restaurantId}/analytics/summary`);
        const data = await response.json();
        setStats(data);

        // Fetch AI Forecast
        const forecastRes = await fetch(`/r/${restaurantId}/ai/forecast-labor`, {
    ...
    <div className="min-h-screen bg-slate-50 p-6">
      <header className="flex justify-between items-center mb-8">
        ...
        <div className="flex gap-3">
          <Link to={`/r/${restaurantId}/admin/settings`} className="p-2 bg-white border border-slate-200 rounded-lg hover:bg-slate-50 transition-colors">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Link to={`/r/${restaurantId}/warehouse/inventory`} className="group bg-white p-8 rounded-3xl shadow-sm border border-slate-100 hover:border-blue-200 transition-all hover:shadow-md">
            ...
            <Link to={`/r/${restaurantId}/warehouse/operations`} className="group bg-white p-8 rounded-3xl shadow-sm border border-slate-100 hover:border-emerald-200 transition-all hover:shadow-md">
            ...
            <Link to={`/r/${restaurantId}/warehouse/logistics`} className="group bg-white p-8 rounded-3xl shadow-sm border border-slate-100 hover:border-indigo-200 transition-all hover:shadow-md">
