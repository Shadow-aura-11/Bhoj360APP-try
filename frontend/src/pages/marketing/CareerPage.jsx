...
export default function CareerPage() {
  useDocumentMetadata(
    'Careers at Multi-OS Platform - Build the Future of Hospitality Technology',
    'Join the Multi-OS Platform team and shape the future of cloud restaurant management. Explore open opportunities in sales, engineering, product design, and customer success.'
  );
        ...
        <div className="max-w-4xl mx-auto space-y-12 text-left">
          ...
          <div className="space-y-4">
            ...
            <p className="text-[rgba(245,240,235,0.7)] text-lg md:text-xl font-light leading-relaxed">
              {isHindi
                ? "Multi-OS Platform में, हम आतिथ्य तकनीक (Hospitality Technology) और क्लाउड रेस्तरां प्रबंधन (Cloud Enterprise Management) के सबसे जटिल परिचालन मुद्दों को हल करने के लिए समर्पित हैं। हमारे मिशन में शामिल हों और हमारे अभिनव रेस्तरां सॉफ्टवेयर (Restaurant Software) का हिस्सा बनें।"
