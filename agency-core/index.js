...
app.put('/api/restaurants/:id', requireAgencyAuth, async (req, res) => {
  const { name, active, online, pins, logo_url, description, logout_redirect_url, login_theme_color, location, contact_email, contact_phone, blockedFeatures, type } = req.body;
  const { id } = req.params;
